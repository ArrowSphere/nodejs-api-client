...
export enum RenewalAlertClassificationEnum {
  IAAS = 'iaas',
  SAAS = 'saas',
  PSW = 'psw',
  FTSL = 'ftsl',
...
export type RenewalFiltersType = {
  ...
  [RenewalFiltersFields.COLUMN_CLASSIFICATION]?: RenewalAlertClassificationEnum;
...
export class RenewalFilters extends AbstractEntity<RenewalFiltersType> {
  ...
  readonly #classification?: RenewalAlertClassificationEnum;
  ...
  get classification(): RenewalAlertClassificationEnum | undefined {
