...
export class OrderProduct extends AbstractEntity<OrderProductsType> {
  ...
  public constructor(getOrderProducts: OrderProductsType) {
    ...
    this.#creationDate =
      getOrderProducts[OrderProductsFields.COLUMN_CREATION_DATE];
    ...
    this.#family = new Family(
      getOrderProducts[OrderProductsFields.COLUMN_FAMILY],
    );
    ...
    this.#source = getOrderProducts[OrderProductsFields.COLUMN_SOURCE];
    this.#vendorName = getOrderProducts[OrderProductsFields.COLUMN_VENDOR_NAME];
  }
