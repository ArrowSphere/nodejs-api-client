...
import {
  ...
  GetAdminDataQuery,
} from './types/wellArchitectedGraphQLQueries';
import {
  GetAdminData,
  GetAdminDataType,
...
export class WellArchitectedGraphQLClient extends AbstractGraphQLClient {
  /**
  ...
  public async getPartnerData(
    ...
    if (getPartnerDataResult) {
      return new GetPartnerData(
        getPartnerDataResult[WellArchitectedQueries.GET_PARTNER_DATA],
      ).toJSON();
    }
  ...
  public async getAdminData(
    ...
    if (getAdminDataResult) {
      return new GetAdminData(
        getAdminDataResult[WellArchitectedQueries.GET_ADMIN_DATA],
      ).toJSON();
    }
  ...
  public async getCustomerData(
    ...
    if (getCustomerDataResult) {
      return new GetCustomerData(
        getCustomerDataResult[WellArchitectedQueries.GET_CUSTOMER_DATA],
      ).toJSON();
    }
