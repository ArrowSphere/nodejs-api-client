...
import { RatesDataFields } from '../../src/licenses/entities/getLicense/ratesGetResult';
  ...
  data: {
    license: {
      ...
      [LicenseGetFields.COLUMN_RATES]: {
        [RatesDataFields.COLUMN_ARROW_SELL_RATE]: 0.1,
        [RatesDataFields.COLUMN_MSP_SELL_RATE]: 0.05,
      },
    },
  },
};
