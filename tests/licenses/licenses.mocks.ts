...
export const PAYLOAD_LICENSE_PATCH_SCHEDULED_TASKS: Omit<
  ScheduleTasks,
  'executionDate'
> = {
...
export const LICENSE_SCHEDULED_TASKS_GET_DATA: GetScheduleTaskResultData = {
  [GetScheduleTaskResultFields.COLUMN_CREATED_AT]: '2024-04-07T20:26:08+00:00',
  ...
  [GetScheduleTaskResultFields.COLUMN_TERM]: 8640,
  [GetScheduleTaskResultFields.COLUMN_UPDATED_AT]: '2024-04-07T20:27:09+00:00',
};

export const LICENSE_SCHEDULED_TASKS_GET_RESPONSE: GetData<GetScheduleTaskResultData> = {
  [GetResultFields.COLUMN_STATUS]: constants.HTTP_STATUS_OK,
  [GetResultFields.COLUMN_DATA]: LICENSE_SCHEDULED_TASKS_GET_DATA,
};
