...
export const ORGANISATION_UNIT_RESPONSE_LIST_MOCK: GetData<OrganizationUnitListType> = {
...
export const ORGANISATION_UNIT_CREATE_RESPONSE_MOCK: GetData<OrganizationUnitType> = {
...
export const ORGANISATION_UNIT_GET_RESPONSE_MOCK: GetData<OrganizationUnitType> = {
  [GetResultFields.COLUMN_STATUS]: constants.HTTP_STATUS_OK,
  [GetResultFields.COLUMN_DATA]: {
    [OrganizationUnitFields.COLUMN_ORGANIZATION_UNIT_REF]: 'XSPOU17727',
    [OrganizationUnitFields.COLUMN_COMPANY_REF]: 'XSP17727',
...
export const ORGANISATION_UNIT_PATCH_RESPONSE_MOCK: GetData<OrganizationUnitType> = {
  [GetResultFields.COLUMN_STATUS]: constants.HTTP_STATUS_OK,
  [GetResultFields.COLUMN_DATA]: {
    [OrganizationUnitFields.COLUMN_ORGANIZATION_UNIT_REF]: 'XSPOU17727',
    [OrganizationUnitFields.COLUMN_COMPANY_REF]: 'XSP17727',
