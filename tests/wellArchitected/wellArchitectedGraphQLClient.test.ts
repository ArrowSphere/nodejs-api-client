...
import * as WellArchitectedQueryMock from './mocks/wellArchitectedQueries.mocks';
import { GraphQLClient } from 'graphql-request';
import { WELL_ARCHITECTED_MOCK_URL } from './mocks/wellArchitectedQueries.mocks';

describe('WellArchitectedGraphQLClient', () => {
  const client = new WellArchitectedGraphQLClient().setUrl(
    WELL_ARCHITECTED_MOCK_URL,
  );
  ...
  describe('getPartnerData', () => {
    it('makes a graphql POST request on the specified URL getPartnerData', async () => {
      ...
      const result: GetPartnerDataType | null = await client.getPartnerData(
        WellArchitectedQueryMock.GET_PARTNER_DATA_QUERY,
      );
      ...
      expect(graphQLClient.request).to.be.calledOnceWithExactly(
        WellArchitectedQueryMock.GET_PARTNER_DATA_GQL,
      );
    });
  ...
  describe('getAdminData', () => {
    it('makes a graphql POST request on the specified URL getAdminData', async () => {
      ...
      const result: GetAdminDataType | null = await client.getAdminData(
        WellArchitectedQueryMock.GET_ADMIN_DATA_QUERY,
      );
      ...
      expect(graphQLClient.request).to.be.calledOnceWithExactly(
        WellArchitectedQueryMock.GET_ADMIN_DATA_GQL,
      );
    });
  ...
  describe('getCustomerData', () => {
    it('makes a graphql POST request on the specified URL getCustomerData', async () => {
      ...
      const result: GetCustomerDataType | null = await client.getCustomerData(
        WellArchitectedQueryMock.GET_CUSTOMER_DATA_QUERY,
      );
      ...
      expect(graphQLClient.request).to.be.calledOnceWithExactly(
        WellArchitectedQueryMock.GET_CUSTOMER_DATA_GQL,
      );
    });
  ...
  describe('getCustomerAccountData', () => {
    it('makes a graphql POST request on the specified URL getCustomerAccountData', async () => {
      ...
      const result: GetCustomerAccountDataType | null = await client.getCustomerAccountData(
        WellArchitectedQueryMock.GET_CUSTOMER_ACCOUNT_DATA_QUERY,
      );
      ...
      expect(graphQLClient.request).to.be.calledOnceWithExactly(
        WellArchitectedQueryMock.GET_CUSTOMER_ACCOUNT_DATA_GQL,
      );
    });
