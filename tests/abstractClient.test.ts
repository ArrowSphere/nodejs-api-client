...
describe('AbstractClient', () => {
  ...
  describe('constructor', () => {
    ...
    it('creates a new instance of TestClient with object parameters', () => {
      const configurations: ConfigurationsClient = {
        ...
        [ParameterKeys.EXTRA_INFORMATION]: {
          application: 'xxxxxxx',
        },
      };
      ...
      expect(client['extraInformation']).to.be.deep.equal({
        extraInformation: configurations[ParameterKeys.EXTRA_INFORMATION],
      });
    });
  });
  ...
  describe('generatePayload', () => {
    it('should generate payload without extraInformation', () => {
      const result: Payload = client['generatePayload'](expectedData);
      expect(result).to.be.deep.equals(expectedData);
    });

    it('should generate payload with extraInformation', () => {
      const extraInformation = { source: 'myApplication' };
      ...
      expect(result).to.be.deep.equals(expectedPayload);
    });
  });
});
