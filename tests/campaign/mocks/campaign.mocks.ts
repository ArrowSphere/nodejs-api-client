...
export const GET_ACTIVE_CAMPAIGNS_V2_WITHOUT_FEATURE_ITEMS_OUTPUT: GetData<CampaignListType> = {
  status: 200,
  data: [
    {
      [CampaignV2Fields.COLUMN_REFERENCE]:
...
export const GET_ACTIVE_CAMPAIGNS_V2_WITHOUT_FEATURE_OUTPUT: GetData<CampaignListType> = {
  status: 200,
  data: [
    {
      [CampaignV2Fields.COLUMN_REFERENCE]:
